...
def run_rf_model_mlflow(df):
    ...
    os.environ['MLFLOW_TRACKING_USERNAME'] = "WildanMukmin"
    os.environ['MLFLOW_TRACKING_PASSWORD'] = "1c0206f99290195da528d062f82c748dd8f0dc8c"
    ...
    fitur_form = ["Age", "MonthlyIncome", "JobLevel", "YearsAtCompany"]
    
    X = df_clean[fitur_form].copy()
    ...
    with mlflow.start_run(run_name="rf-model-10-features", experiment_id=experiment_id) as run:
        # Melatih Model
